...
COMMANDS = OrderedDict([('main', OrderedDict([('PWR', {'values': OrderedDict([('00', {'name': 'standby',
  ...
  ('SLP', {'values': OrderedDict([('\u201c01\u201d-\u201c5A\u201d', {'name': 'time-1-90min',
  ...
  ('SWL', {'values': OrderedDict([((-30,
     0,
     24), {'name': '15-0db-0-0db-12-0db', 'description': 'sets Subwoofer Level -15.0dB - 0.0dB - +12.0dB(0.5dB Step)'}),
    ((-15, 0, 12), {'name': '15db-0db-12db',
  ...
  ('SW2', {'values': OrderedDict([((-30,
     0,
     24), {'name': '15-0db-0-0db-12-0db', 'description': 'sets Subwoofer 2 Level -15.0dB - 0.0dB - +12.0dB(0.5dB Step)'}),
    ((-15, 0, 12), {'name': '15db-0db-12db',
  ...
  ('CTL', {'values': OrderedDict([((-24,
     0,
     24), {'name': '12-0db-0-0db-12-0db', 'description': 'sets Center Level -12.0dB - 0.0dB - +12.0dB(0.5dB Step)'}),
    ((-12, 0, 12), {'name': '12db-0db-12db',
  ...
  ('TCL', {'values': OrderedDict([('aaabbbcccdddeeefffggghhhiiijjjkkklllmmm', {'name': None,
  ...
  ('OSD', {'values': OrderedDict([('MENU', {'name': 'menu',
    ...
    ('QUICK', {'name': 'quick', 'description': 'Quick Setup Key'}),
  ...
  ('IFA', {'values': OrderedDict([('a..a,b..b,c\u2026c,d..d,e\u2026e,f\u2026f,', {'name': 'a-a-b-b-c-c-d-d-e-e-f-f',
    ...
    ('a..a,b..b,c\u2026c,d..d,e\u2026e,f\u2026f,g\u2026g,h\u2026h,i\u2026I,j\u2026j', {'name': 'a-a-b-b-c-c-d-d-e-e-f-f-g-g-h-h-i-i-j-j',
  ...
  ('IFV', {'values': OrderedDict([('a..a,b..b,c\u2026c,d..d,e\u2026e,f\u2026f,g\u2026g,h\u2026h,i\u2026i,', {'name': 'a-a-b-b-c-c-d-d-e-e-f-f-g-g-h-h-i-i',
  ...
  ('CCM', {'values': OrderedDict([('01', {'name': None,
  ...
  ('SPR', {'values': OrderedDict([((0, 3), {'name': None,
  ...
  ('AEQ', {'values': OrderedDict([('00', {'name': 'off',
   ...
   'name': 'accueq',
   'description': 'AccuEQ'}),
  ('MCM', {'values': OrderedDict([('01', {'name': '1',
     'description': 'sets MCACC MEMORY 1'}),
    ('02', {'name': '2', 'description': 'sets MCACC MEMORY 2'}),
    ('03', {'name': '3', 'description': 'sets MCACC MEMORY 3'}),
    ('04', {'name': '4', 'description': 'sets MCACC MEMORY 4'}),
    ('05', {'name': '5', 'description': 'sets MCACC MEMORY 5'}),
    ('06', {'name': '6', 'description': 'sets MCACC MEMORY 6'}),
  ...
  ('ACE', {'values': OrderedDict([('aaabbbcccdddeeefffggghhhiii', {'name': None,
     'description': 'sets All Channel EQ\nxxx=-18(-12.0dB)~000(0.0dB)~+18(+12.0dB)\n\naaa:63Hz\nbbb:125Hz\nccc:250Hz\nddd:500Hz\neee:1kHz\nfff:2kHz\nggg:4kHz\nhhh:8kHz\niii:16kHz'}),
    ('QSTN', {'name': 'query', 'description': 'gets The Phase Control'})]),
   'name': 'all-channel-eq',
   'description': 'All Channel EQ'}),
  ...
  ('AVS', {'values': OrderedDict([('snnn', {'name': None,
  ...
  ('DMS', {'values': OrderedDict([('-3"~"00"~"+3', {'name': None,
  ...
  ('CTW', {'values': OrderedDict([('00"~"07', {'name': None,
  ...
  ('CTI', {'values': OrderedDict([('00"~"0A', {'name': None,
  ...
  ('DLC', {'values': OrderedDict([('00"~"+6', {'name': None,
  ...
  ('DMN', {'values': OrderedDict([('00', {'name': None,
     'description': 'sets DUAL MONO MAIN'}),
    ('01', {'name': 'sub', 'description': 'sets DUAL MONO SUB'}),
    ('02', {'name': 'sub', 'description': 'sets DUAL MONO MAIN+SUB'}),
  ...
  ('ITV', {'values': OrderedDict([((-24, 0, 24), {'name': '12-0db-0db-12-0db',
   ...
   'name': 'intellivolume-input-level-absorber',
   'description': 'IntelliVolume / Input Level Absorber'}),
  ...
  ('FWV', {'values': OrderedDict([('abce-fhik-lmno-qrtu', {'name': None,
  ...
  ('PTS', {'values': OrderedDict([('\u201c01\u201d-\u201c1D\u201d', {'name': 'no-1-29',
 ...
 ('zone2', OrderedDict([('ZPW', {'values': OrderedDict([('00', {'name': 'standby',
  ...
  ('ZPA"/"ZPB', {'values': OrderedDict([('00', {'name': ('off'),
     'description': 'sets Zone 2 A/B Off'}),
    ('01', {'name': ('on'), 'description': 'sets Zone 2 A/B On'}),
    ('QSTN', {'name': 'query', 'description': 'gets the Speaker State'})]),
   'name': 'zone-2-a-b',
   'description': 'Zone 2 A/B Command'}),
 ...
 ('dock', OrderedDict([('NTC', {'values': OrderedDict([('PLAY', {'name': 'play',
  ...
  ('NSV', {'values': OrderedDict([('ssiaaaa\u2026aaaabbbb\u2026bbbb', {'name': None,
  ...
  ('NPU', {'values': OrderedDict([('xaaa\u2026aaaybbb\u2026bbb', {'name': None,
  ...
  ('NLT', {'values': OrderedDict([('{xx}uycccciiiillrraabbssnnn...nnn', {'name': None,
  ...
  ('NRI', {'values': OrderedDict([('<\u2026>', {'name': None,
  ...
  ('NRF', {'values': OrderedDict([((1, 40), {'name': None,
  ...
  ('AAL', {'values': OrderedDict([('nnnnnnn', {'name': None,
     'description': 'NET/USB Album Name (variable-length, 64 Unicode letters [UTF-8 encoded] max , for Network Control only)'}),
  ...
  ('ATI', {'values': OrderedDict([('nnnnnnnnnn', {'name': None,
     'description': 'NET/USB Title Name (variable-length, 64 Unicode letters [UTF-8 encoded] max , for Network Control only)'}),
    ('QSTN', {'name': 'query', 'description': 'gets HD Radio Title'})]),
...
COMMAND_MAPPINGS = {'zone3': {'tone': 'TN3',
 ...
 'dock': {'airplay-artist-name-info': 'AAT',
  'network-usb': 'NTC',
...
VALUE_MAPPINGS = {'zone3': {'PW3': {'standby': '00', 'on': '01', 'query': 'QSTN'},
 ...
 'zone2': {'TUZ': {'6-in-direct-mode': '6',
  ...
  'ZPA"/"ZPB': {'on': '01', 'off': '00', 'query': 'QSTN'},
  'NTZ': {'right': 'RIGHT',
   'chup': 'CHUP',
   'random': 'RANDOM',
   'down': 'DOWN',
 ...
 'main': {'HBL': {'auto': '00', 'analog': '01', 'query': 'QSTN'},
  'CCM': {'zone2': '02', 'query': 'QSTN', 'sub': '10', 'up': 'UP'},
  ...
  'SPR': {'down': 'DOWN', 'query': 'QSTN', 'up': 'UP', range(3): (0, 3)},
  ...
  'IFV': {'a-a-b-b-c-c-d-d-e-e-f-f-g-g-h-h-i-i': 'a..a,b..b,c\u2026c,d..d,e\u2026e,f\u2026f,g\u2026g,h\u2026h,i\u2026i,',
   'query': 'QSTN'},
  'HDS': {'query': 'QSTN'},
  'PCP': {range(16): (0, 16),
   'auto': 'AT',
  ...
  'PCT': {'on': '01',
   ...
   'up': 'UP',
   'full-band-on': '02'},
  'DMS': {'down': 'DOWN', 'query': 'QSTN', 'up': 'UP'},
  'IFA': {'a-a-b-b-c-c-d-d-e-e-f-f': 'a..a,b..b,c\u2026c,d..d,e\u2026e,f\u2026f,',
  ...
  'SCH': {'down': 'DOWN', 'query': 'QSTN', range(597): (0, 597), 'up': 'UP'},
  ...
  'CTI': {'down': 'DOWN', 'query': 'QSTN', 'up': 'UP'},
  'TCL': {'query': 'QSTN'},
  ...
  'DLC': {'down': 'DOWN', 'query': 'QSTN', 'up': 'UP'},
  'UPD': {'00': '00',
   '01': '01',
   'usb': 'USB',
   'd-nn': 'D**-nn',
  ...
  'STI': {'query': 'QSTN'},
  'HCN': {'query': 'QSTN'},
  'UPS': {'x2': '01', 'query': 'QSTN', 'x1': '00', 'up': 'UP', 'x4': '02'},
  'XCH': {'down': 'DOWN', 'query': 'QSTN', range(597): (0, 597), 'up': 'UP'},
  'XCN': {'query': 'QSTN'},
  'HTI': {'query': 'QSTN'},
  'AVS': {'query': 'QSTN', 'is-decreased': 'DOWN', 'is-increased': 'UP'},
  'VWM': {'4-3': '01',
   'smart-zoom': '05',
   'auto': '00',
   'up': 'UP',
  ...
  'DVL': {'on': '01',
   ...
   'low': '01',
   'query': 'QSTN'},
  'CTW': {'down': 'DOWN', 'query': 'QSTN', 'up': 'UP'},
  'ACE': {'query': 'QSTN'},
  'CTS': {'center-off': '00',
   'toggle': 'TG',
   'center-on': '01',
  ...
  'LFE': {'down': 'DOWN',
   ...
   'up': 'UP'},
  'DGF': {'sharp': '01', 'slow': '00', 'up': 'UP', 'query': 'QSTN'},
