...
VALUE_MAPPINGS = {'zone3': {'PW3': {'standby': '00', 'on': '01', 'query': 'QSTN'},
 ...
 'main': {'HBL': {'auto': '00', 'analog': '01', 'query': 'QSTN'},
  ...
  'PAM': {'all': '07',
   ...
   'query': 'QSTN',
   'front-center': '03'},
  'PRM': {ValueRange(1, 40): (1, 40), ValueRange(1, 30): (1, 30)},
  'SPR': {'down': 'DOWN',
   'query': 'QSTN',
   ValueRange(0, 3): (0, 3),
   'up': 'UP'},
  ...
  'MCM': {'down': 'DOWN',
   ...
   '6': '06',
   'query': 'QSTN'},
  'PWR': {'standby': '00', 'on': '01', 'off': '00', 'query': 'QSTN'},
  'TFH': {'treble-up': 'TUP',
   'bass-up': 'BUP',
   'bass-down': 'BDOWN',
   'treble-down': 'TDOWN',
 ...
 'dock': {'NAF': {'xx-xx': '{xx}{xx}'},
  ...
  'NTC': {'f1': 'F1',
   ...
   'display': 'DISPLAY',
   'left': 'LEFT'},
  'NPR': {'set': 'SET', ValueRange(1, 40): (1, 40)}},
